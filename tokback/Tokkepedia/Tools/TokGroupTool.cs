...
namespace Tokkepedia.Tools
{
    ...
    public static class TokGroupTool
    {
        public static List<TokTypeList> TokGroups { get; set; } = new List<TokTypeList>()
        {
            ...
            new TokTypeList()
            {
                ...
                Descriptions = new string[]
                {
                    ...
                    "Any practice",
                    "Long term approach to accomplish a long term objective",
            ...
            new TokTypeList()
            {
                ...
                Examples = new string[]
                {
                    ...
                    "Coach Frank Martin's Miracle 2016:  1. He was near death due to pancreatic cancer 2. A nurse kneeled and grabbed his hand and began to pray..  3. He was healed , no longer having pancreatic cancer, and the nurse was never seen again.",
                    ...
                    "Hamlet: 1.Written by William Shakespeare at an uncertain date between 1599 and 1602. 2. Set in Denmark, the play dramatises the revenge Prince Hamlet is called to wreak upon his uncle, Claudius, by the ghost of Hamlet's father, King Hamlet. 3. It is Shakespeare's longest play.",
            ...
            new TokTypeList()
            {
                ...
                Examples = new string[]
                {
                    ...
                    "Math: 1.  It is the study of quantity, structure, space, and change 2. Involves problem solving, numbers, etc. 3. Calculators are used to solve long math problems.",
            ...
            new TokTypeList()
            {
                ...
                Descriptions = new string[]
                {
                    ...
                    "Other Abbreviation that doesn't belong in one of the types"
                },
