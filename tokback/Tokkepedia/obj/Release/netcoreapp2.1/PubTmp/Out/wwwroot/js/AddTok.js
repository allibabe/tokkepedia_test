...
$(document).ready(function () { 
    ...
    $("#SelectGroup").change(function () {
        ...
        if ($("#SelectGroup").val() != 'Choose') {
            ...
            SelectGroupOptions.success = function (GetSubtypes) {
                ...
                $("#txtDetail1").attr('maxlength', secondaryLimit);
                $("#txtDetail2").attr('maxlength', secondaryLimit);
                $("#txtDetail3").attr('maxlength', secondaryLimit);
                $("#txtDetail4").attr('maxlength', secondaryLimit);
                $("#txtDetail5").attr('maxlength', secondaryLimit);

                $("#txtEnglishPrimary").attr('maxlength', primaryLimit);
                $("#txtEnglishSecondary").attr('maxlength', secondaryLimit);
                $("#txtEnglishDetail1").attr('maxlength', secondaryLimit);
                $("#txtEnglishDetail2").attr('maxlength', secondaryLimit);
                $("#txtEnglishDetail3").attr('maxlength', secondaryLimit);
                $("#txtEnglishDetail4").attr('maxlength', secondaryLimit);
                $("#txtEnglishDetail5").attr('maxlength', secondaryLimit);
    ...
    $("#txtDetail1").on('input', function () {
        var max = $("#SecondaryLimit").val();
        $('#lblDetail1Num').text((max - $("#txtDetail1").val().length));

        if ($("#txtDetail1").val().length == 0) {
            $('#lblDetail1Num').text('');
        }
    ...
    $("#txtEnglishDetail1").on('input', function () {
        var max = $("#SecondaryLimit").val();
        $('#lblEnglishDetail1Num').text((max - $("#txtEnglishDetail1").val().length));

        if ($("#txtEnglishDetail1").val().length == 0) {
            $('#lblEnglishDetail1Num').text('');
        }
